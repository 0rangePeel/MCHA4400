...
public:
    ...
    virtual double logLikelihood(const State & state, const Eigen::VectorXd & x, std::size_t idxLandmark, int j, Eigen::VectorXd & g) const = 0;
    virtual double logLikelihood(const State & state, const Eigen::VectorXd & x, std::size_t idxLandmark, int j, Eigen::VectorXd & g, Eigen::MatrixXd & H) const = 0;
